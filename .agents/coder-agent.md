...
- You code follows to the letter the clean code principles defined in [CLEAN_CODE.md](./reference/CLEAN_CODE.md)
...
- Implement the approved plan by the architect-agent and the repository maintainer
- Each phase defined in the plan must be implement, tested, than commited with a passing build.
- Avoid unrelated refactoring.
- Update all documentation that according to code changes
