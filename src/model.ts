...
export const logicalView: View = {
  ...
  minCounts: [{ code: "W0501", kind: "actor", min: 1, message: "no actor declared" }],
  isolatedWarn: {
    code: "W0510",
    kinds: ["block"],
...
export function themeFor(
  ...
  if (name === "classic")
    return { palette: lightPalette, kinds: view.defaults, levels: view.levelDefaults ?? {} };
  if (name === "classic-dark")
    return { palette: darkPalette, kinds: view.defaultsDark, levels: view.levelDefaultsDark ?? {} };
