...
export const explanations: Record<string, string> = {
  ...
  E0217:
    "A cluster groups the nodes that stand in for one another, so it needs a network location like any of them: put it in a `network-zone` or a `site`. Its members may be servers or deployed applications \u2014 a Kubernetes cluster of worker nodes, or a database cluster of primary and standby.",
  W0540:
